...
public class PlayerShip extends Ship
	{
		...
		private static final Bounds PLAYER_BOUNDS = new Bounds(new Rectangle(104, 64, 28, 16),
				new Rectangle(96, 60, 8, 24), new Rectangle(72, 36, 24, 72), new Rectangle(56, 32,
						16, 80), new Rectangle(52, 28, 4, 88), new Rectangle(48, 24, 4, 96),
				new Rectangle(44, 16, 4, 112), new Rectangle(28, 12, 16, 120), new Rectangle(24,
						16, 4, 112), new Rectangle(12, 28, 14, 88));

		public PlayerShip(PointDouble location, Screen screen)
			{
				super(PLAYER_SHIP_IMAGE, location, INITIAL_HEALTH, new LaserTurret(
						Utils.loadImage("turret.png"), 10, FIRE_RATE, new Laser(new PointDouble(1,
								1), 10, null, screen), null, screen), PLAYER_BOUNDS, screen);
		...
		public boolean isEnemy(Ship s) {
			if (s instanceof PlayerShip) return false;
			return true;
		}
