...
public class LaserTurret extends Turret {
	...
	public Projectile addProjectile(double direction) {
		return new Projectile(projectile.img, getPosition(), direction,
				projectile.damage, projectile.velocity, ship, new Bounds(
						projectile.collisionArea.getArea()), screen);
	}
}
