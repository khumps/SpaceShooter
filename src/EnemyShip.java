...
public class EnemyShip extends Ship
	{
		...
		public EnemyShip(PointDouble point, int scoreModifier, Screen screen)
			{
				super(ENEMY_SHIP_IMAGE, point, INITIAL_HEALTH, new LaserTurret(Turret.TURRET_IMAGE,
						10, 20, new Bullet(new PointDouble(1, 1), 0, null, screen), null, screen),
						new Bounds(new Rectangle(16, 16, 104, 28), new Rectangle(16, 100, 104, 28),
								new Rectangle(16, 44, 64, 56)), screen);
			...
			if (tickNum % 10 == 0)
				{
					 ...
					 * }
					 */
					else if (tickNum % 25 == 0) setOrientation(Math.random() * Math.PI * 2);
				}
			move(velocity);
		}
		...
		public boolean isEnemy(Ship s) {
			if (s instanceof EnemyShip) return false;
			return true;
		}
	}
